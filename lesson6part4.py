...
opel = TownCar(30, 'grey', 'Opel', False)
lada = WorkCar(70, 'yellow', 'Lada', True)
pontiac = PoliceCar(110, 'black', 'Pontiac', True)
print(lada.turn_left())
print(f'When {opel.turn_right()}, then {ferrari.stop()}')
